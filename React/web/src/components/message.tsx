    ...
    return (
        ...
        >
            ...
            {hasReacted ? (
                <button 
                    type="button" 
                    className="flex items-center gap-2 text-orange-400 text-sm font-medium hover:text-orange-500"
                >
                ...
                <button 
                    ...
                    type="button" 
                    className="flex items-center gap-2 text-zinc-400 text-sm font-medium hover:text-zinc-300"
                >
                    <ArrowUp className="size-4" />
                    Curtir Pergunta ({amountOfReactions})
                </button>      
